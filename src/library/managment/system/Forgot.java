...
public class Forgot extends JFrame implements ActionListener {
    ...
    public Forgot(){
        ...
        panel.setBorder(new TitledBorder (new LineBorder (new Color(139,69,19),2),
                            "Forgot Panel", TitledBorder.LEADING,TitledBorder.TOP,null,
                            new Color(178,34,34)));
